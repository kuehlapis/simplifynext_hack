  ...
  const getDownloadHref = (a: Artifact) => {
    if (a.url.startsWith('http')) return a.url;        // Supabase/public
    const filename = a.url.split(/[\\/]/).pop()!;      // works for \ or /
    return `/download-file/${encodeURIComponent(filename)}`;
  };
